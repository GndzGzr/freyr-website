...
const ServiceCard = ({
  ...
  return (
    <div className="service-card relative flex flex-col justify-center items-start w-full h-full gap-6 md:gap-8 p-6 md:p-8 lg:p-12">
      ...
      <p className="service-card-text-description text-left mb-12 md:mb-24">
        {description}
      </p>
