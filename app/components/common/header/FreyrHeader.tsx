...
const FreyerHeader = () => {
  ...
  return (
    <header className="relative z-50">
      <div className="h-fit flex justify-between items-center font-sans border-2 border-solid border-gray w-full py-4 px-4 md:px-12 lg:px-24">
        <FreyrLogo />
      ...
      {/* Mobile menu overlay */}
      {menuOpen && (
        <div className="md:hidden absolute top-full left-0 w-full bg-[var(--background)] border-b-2 border-[var(--border-gray)] z-50">
