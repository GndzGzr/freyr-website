...
const services: Service[] = [
  {
    ...
    description:
      "FREYR, ulusal ve uluslararası kongrelerin tüm boyutlarını profesyonel şekilde yönetir. Yüksek katılımlı ve kusursuz uygulama kalitesiyle akademik ve sektörel etkinlikler düzenliyoruz.",
    iconSrc: "/Vector(2).svg",
    bullets: [
      "Bilimsel program koordinasyonu",
      "Konuşmacı & misafir yönetimi",
      "Online kayıt sistemleri",
      "Fuar alanı planlaması",
      "Bilimsel program koordinasyonu",
      "Konuşmacı & misafir yönetimi",
      "Online kayıt sistemleri",
      "Fuar alanı planlaması",
  ...
  {
    id: "02",
    title: "Kurumsal Etkinlikler & Toplantılar",
    description:
      "Yönetim kurulu toplantılarından büyük ölçekli kurumsal zirvelere kadar her detayı titizlikle yönetiyoruz. İş birliğini ve marka varlığını güçlendiren profesyonel ortamlar oluşturuyoruz.",
    iconSrc: "/Vector(3).svg",
    bullets: [
      "Mekan seçimi & kurulumu",
      "Ses/görsel prodüksiyon",
      "Katılımcı koordinasyonu",
      "Kurumsal marka entegrasyonu",
      "Canlı yayın & hibrit etkinlikler",
      "Etkinlik sonrası raporlama",
      "İkram & misafirperver hizmet yönetimi",
      "Gerçek zamanlı saha desteği",
    ],
  },
  {
    id: "03",
    title: "Fuar & Sergi Yönetimi",
    description:
      "FREYR; sektör liderlerini buluşturan ve katılımcı etkileşimini yaratıcı stant tasarımı ile lojistik çözümler aracılığıyla en üst düzeye taşıyan fuarlar ve sergiler tasarlayıp yönetir.",
    iconSrc: "/Vector(4).svg",
    bullets: [
      "Stant tasarımı & inşaatı",
      "Katılımcı koordinasyonu",
      "Ziyaretçi akış yönetimi",
      "Tanıtım materyali üretimi",
      "Sponsorluk yönetimi",
      "Potansiyel müşteri oluşturma sistemleri",
      "Etkinlik sonrası analitik",
      "Uluslararası katılımcı desteği",
    ],
  },
  {
    id: "04",
    title: "Sosyal & Gala Etkinlikleri",
    description:
      "Gala yemeklerinden ödül törenlerine kadar şık ve unutulmaz sosyal buluşmalar tasarlıyor; her anın prestij, stil ve kusursuz organizasyon ruhunu yansıtmasını sağlıyoruz.",
    iconSrc: "/Vector(5).svg",
    bullets: [
      "Tematik konsept & dekor",
      "Eğlence & sahne sanatçıları",
      "Lüks ikram yönetimi",
      "Ödül töreni prodüksiyonu",
      "Kırmızı halı & fotoğrafçılık",
      "VIP misafir yönetimi",
      "Işık & atmosfer tasarımı",
      "Etkinlik zaman çizelgesi yönetimi",
    ],
  },
  {
    id: "05",
    title: "Kültürel & Sportif Etkinlikler",
    description:
      "FREYR, kültürel festivalleri, spor turnuvalarını ve topluluk etkinliklerini enerji ve titizlikle hayata geçirerek katılımcılar ve izleyiciler için unutulmaz deneyimler yaratır.",
    iconSrc: "/Vector(6).svg",
    bullets: [
      "Etkinlik konsepti geliştirme",
      "Biletleme & akreditasyon",
      "Sporcu & sanatçı koordinasyonu",
      "Kalabalık & güvenlik yönetimi",
      "Medya & basın ilişkileri",
